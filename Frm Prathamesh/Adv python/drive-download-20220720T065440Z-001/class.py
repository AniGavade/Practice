...
# # ======================================================================================================================
#
# # the __init__ method is special method that python runs automatically when we create a new instance based on that class
# # self parameter is required in method definition because when python calls this method later (after creating instance
# # of that class), and method call will automatically pass the self argument.
...
# # self.name = name takes the value associated with the parameter name and assigns it to the variable name, which is then
# # attached to the instance being created.
...
# # the __init__() method in Man with the arguments 'Shyam' and 30. The __init__() method creates an instance representing
# # this particular person and sets the name and age attributes using the values we provided.
...
#
# # we can extend the method update_odometer() to do additional work so that every time odometer reading is modified make
# # sure no one can roll back the odometer reading
#
...
#                                        # instance and it won't get change again if we change class variable using class
#                                        # later
# print(Employee.raise_percentage)
# print(emp1.raise_percentage)
# print(emp2.raise_percentage)
